            ...
            <div id="list" class="row">
                <div class="table-responsive col-md-12">
                    ...
                    while ($info = mysqli_fetch_array($data)) {
                        ...
                        echo "<a class='btn btn-success btn-xs' href=view_cli.php&cpf=" . $info['cpf'] . "> Visualizar </a>";
                        echo "<a class='btn btn-warning btn-xs' href=?page=edita_cli&cpf=" . $info['cpf'] . "> Editar </a>";
                        echo "<a href=?page=delete_cli&cpf=" . $info['cpf'] . " class='btn btn-danger btn-xs'> Excluir </a></td>";
                    }
                    echo "</tr></tbody></table>";
                    ?>
                </div>
